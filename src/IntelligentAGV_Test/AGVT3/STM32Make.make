...
GCC_PATH="D:/Sustech/SDIMDependencies/arm-gnu-toolchain-13.2.Rel1-mingw-w64-i686-arm-none-eabi/bin
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"D:/SUSTECH/SDIMDEPENDENCIES/OPENOCD-20231002-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"D:/SUSTECH/SDIMDEPENDENCIES/OPENOCD-20231002-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f4x mass_erase 0; exit"
